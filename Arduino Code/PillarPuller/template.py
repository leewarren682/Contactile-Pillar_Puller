...
class App(customtkinter.CTk):
    def __init__(self, buffer):
        ...
        # Add entry box and button for target force.
        self.filename_entry = customtkinter.CTkEntry(self, placeholder_text="Enter Force (Newtons)")
        self.filename_entry.grid(row=0, column=0, padx=20, pady=(150, 5), sticky="ew")
        self.generate_csv_button = customtkinter.CTkButton(self, text="Test Force", command=lambda: self.generate_csv(self.filename_entry.get()))
        self.generate_csv_button.grid(row=0, column=0, padx=20, pady=(220, 10), sticky="ew")

        # Add entry box and button for target position.
        self.filename_entry = customtkinter.CTkEntry(self, placeholder_text="Enter Position (mm)")
        self.filename_entry.grid(row=0, column=0, padx=20, pady=(300, 5), sticky="ew")
        self.generate_csv_button = customtkinter.CTkButton(self, text="Test Position", command=lambda: self.generate_csv(self.filename_entry.get()))
        self.generate_csv_button.grid(row=0, column=0, padx=20, pady=(370, 10), sticky="ew")
