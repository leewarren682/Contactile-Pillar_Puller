...
void loop() {
  ...
  if((ms-last_time) > 1000) //run every 1s
  {
    ...
    Serial.print(Ms);Serial.print(" ");Serial.print(" Force: "); Serial.print(mass); Serial.print(" N ");Serial.print("Platform Position: "),Serial.print(platformTravel);Serial.println(" mm"); 
